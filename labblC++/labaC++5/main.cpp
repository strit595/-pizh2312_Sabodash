...
int main() {
    ...
    std::cout << "Общее количество объектов Контакт: " << Контакт::getКоличествоОбъектов() << std::endl;
    std::cout << "Количество объектов в массиве Справочник: " << Справочник::getКоличествоОбъектовВМассиве() << std::endl;

    std::cout << "\n=== Создание объектов и добавление в Справочник ===\n";
    Справочник справочник("Личный справочник", "Иван Иванов");

    // Создание объектов классов-наследников и добавление их в массив
    справочник.добавитьКонтакт(new РабочийКонтакт("Иван", "+7-999-234-56-78", "ул. Мира, 10", "Менеджер", "ООО Ромашка"));
    справочник.добавитьКонтакт(new ЛичныйКонтакт("Мария", "+7-999-345-67-89", "пр. Победы, 5", "01.01.1990", "maria@example.com"));
    справочник.добавитьКонтакт(new РабочийКонтакт("Ольга", "+7-999-567-89-01", "ул. Центральная, 20", "Программист", "ООО Код"));

    std::cout << "\n=== Количество объектов после создания ===\n";
    std::cout << "Общее количество объектов Контакт: " << Контакт::getКоличествоОбъектов() << std::endl;
    std::cout << "Количество объектов в массиве Справочник: " << Справочник::getКоличествоОбъектовВМассиве() << std::endl;

    std::cout << "\n=== Вывод данных Справочник ===\n";
